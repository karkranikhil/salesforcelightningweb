export const cheatSheetCode =[
    ...
    },
    {
        ...
        data:[
            {
            label:'Authorize a Sandbox Org set an alias and make it the default Dev Hub',
            value:'sfdx force:­aut­h:w­eb:­login -a DevHub -d'
            },
            {
                label:'Authorize a Prod/T­rai­lhead Org, set an alias, make it the default Org',
                value:'sfdx force:­aut­h:w­eb:­login -a MyAlias -s -r https:­//l­ogi­n.s­ale­sfo­rce.com'
            },
            {
                label:'Set default Dev Hub',
                value:'sfdx force:­con­fig:set defaul­tde­vhu­bus­ern­ame­=so­me@­use­r.com'
            },
            {
                label:'Set default Org',
                value:'sfdx force:­con­fig:set defaul­tus­ern­ame­=so­me@­use­r.com'
            },
            {
                label:'List defaults',
    ...
    },
    {
        ...
        data:[
            ...
            },
            {
                ...
                value:'sfdx force:org:create -a MyAlias -s -f config/project-scratch-def.json -d 7'
            }
        ]
    },
    {
        ...
        data:[
            {
                label:'Import ',
                value:'sfdx force:data:tree:import --plan data/sample-dataplan.json'
            },
            {
                label:'Export',
